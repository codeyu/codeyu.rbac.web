...
$(document).ready(function () {
    $.ajax({
        url: "/SysManage/BaseRole/GetRoleButtonPermission?id=" + GetQuery("id"),
        type: "post",
        dataType: "json",
...
var saveUserButtonPermission = function (id) {
    ...
    $.ajax({
        url: "/SysManage/BaseRole/UpdateRoleButtonPermission?accessValueArray=" + accessValueArray.join(',') + "&id=" + id,
        type: "post",
        dataType: "json",
