...
$(document).ready(function () {
    ...
    $.ajax({
        url: "/SysManage/BaseUser/GetUserDataPermission?id=" + GetQuery("id"),
        type: "post",
        dataType: "json",
...
var SaveUserDataPermission = function (id) {
    ...
    $.ajax({
        url: "/SysManage/BaseUser/UpdateUserDataPermission?accessValueArray=" + accessValueArray.join(',') + "&id=" + id + "&constraint=" + constraint,
        type: "post",
        dataType: "json",
