...
$(document).ready(function () {
    $.ajax({
        url: "/SysManage/BaseUser/GetUserFieldPermission?id=" + GetQuery("id"),
        type: "post",
        dataType: "json",
...
var saveUserFieldPermission = function (id) {
    ...
    $.ajax({
        url: "/SysManage/BaseUser/UpdateUserFieldPermission?accessValueArray=" + accessValueArray.join(',') + "&id=" + id,
        type: "post",
        dataType: "json",
