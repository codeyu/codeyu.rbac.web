...
$(document).ready(function () {
    $.ajax({
        url: "/SysManage/BaseRole/GetRoleModulePermission?id=" + GetQuery("id"),
        type: "post",
        dataType: "json",
...
var saveUserModulePermission = function (id) {
    ...
    $.ajax({
        url: "/SysManage/BaseRole/UpdateRoleModulePermission?accessValueArray=" + accessValueArray.join(',') + "&id=" + id,
        type: "post",
        dataType: "json",
